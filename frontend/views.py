...
def universities(request):
    unis = [
        ...
        {'key': 'uhas', 'name': 'UHAS', 'full': 'University of Health and Allied Sciences', 'location': 'Ho, Volta', 'thumb': 'https://uhas.edu.gh/wp-content/uploads/2021/03/uhas-main-1.jpg', 'color': '#7f1d1d'},
        {'key': 'upsa', 'name': 'UPSA', 'full': 'University of Professional Studies, Accra', 'location': 'Legon, Accra', 'thumb': 'https://upsa.edu.gh/wp-content/uploads/2021/05/upsa-campus.jpg', 'color': '#1e3a8a'},
    ]
